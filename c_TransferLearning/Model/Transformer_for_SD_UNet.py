# -*- coding: utf-8 -*-
# @Time    : 2023/6/15 20:29
# @Author  : Lufeng Wang
# @WeChat  : tofind404
# @File    : Transformer_for_SD_UNet.py
# @Software: PyCharm
"""
---
...
if __name__ == '__main__':
    print('debut')
    attention_1 = SpatialTransformer(64,3,3,32)
    feature_map_1 = torch.randn(8,64,32,32)
    condition_1 = torch.randn(8,32,32)

    with SummaryWriter(logdir=r"C:\Users\Administrator\Desktop\BuiGAN2\BuiGAN\Visual_model") as w:
        w.add_graph(attention_1,(feature_map_1, condition_1))
